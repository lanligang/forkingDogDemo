...
//如果自定义需要实现下面两个方法
-(void)cycleScrollView:(DCCycleScrollView *)cycleScrollView andCell:(UICollectionViewCell *)cell andCurrentpPageIndex:(NSInteger)index;

-(Class)cycleScrollViewItemCustomClass;
